                            ...
                            VStack(spacing: 0){
                                ...
                                HStack{
                                    ...
                                    NavigationLink(destination: {
                                        DetailView_Jinnie().navigationBarBackButtonHidden(true)
                                            .onAppear {
...
struct DetailView_Eric_Previews: PreviewProvider {
    static var previews: some View {
        DetailView_Eric().previewInterfaceOrientation(.landscapeRight)
